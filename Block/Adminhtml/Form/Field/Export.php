 ...
 */
namespace ShippingApps\PocztexRate\Block\Adminhtml\Form\Field;
...
class Export extends \Magento\Framework\Data\Form\Element\AbstractElement
{
    ...
    public function getElementHtml()
    {
        ...
        $url = $this->backendUrl->getUrl("shqpocztexrate/system/exportPocztexrates", $params);
        $data = [
            'label' => __('Export CSV'),
            'onclick' => "setLocation('" .
            $url .
            "conditionName/' + $('carriers_pocztexrate_condition_name').value)",
            'class' => '',
        ];
