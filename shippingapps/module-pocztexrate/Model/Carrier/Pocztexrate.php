 ...
 */
namespace ShippingApps\PocztexRate\Model\Carrier;

use Magento\Framework\Exception\LocalizedException;
use Magento\Quote\Model\Quote\Address\RateRequest;

class Pocztexrate extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'pocztexrate';
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        foreach ($rateArray as $rate) {
            if (!empty($rate) && $rate['price'] >= 0) {
                ...
                $method->setCarrier('pocztexrate');
                $method->setCarrierTitle($this->getConfigData('title'));

                $method->setMethod('pocztexrate_' . $rate['pk']);
    ...
    {
        return $this->pocztexrateFactory->create()->getRate($request, $zipRange);
    }
    ...
    {
        return ['pocztexrate' => $this->getConfigData('name')];
    }
}
