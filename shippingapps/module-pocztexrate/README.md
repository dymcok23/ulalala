# ShipperHQ and ShippingApps PocztexRate
...
Facts
-----
- [extension on GitHub](https://github.com/shippingapps/module-pocztexrate)

Description
-----------
The PocztexRate shipping extension is the original Magento solution that enables you to offer multiple shipping options to customers based on their locations. With PocztexRate you can define different shipping rates according to destination, shipping method and the weight, price or quantity of an item.
...
```
$ composer require shippingapps/module-pocztexrate
$ composer update
...
Configuration
-------------------------
PocztexRate is completely CSV driven, no coding required to change prices, add rates, etc
...
1. Create your CSV file of shipping rates. Please follow [the format of the CSV file described in our online docs](https://docs.shipperhq.com/pocztexrates-csv-configuration). We also have [many example CSVs](https://docs.shipperhq.com/pocztexrates-examples-city-based)  to get you started
...
Full instructions are also available in our [online documentation](http://docs.shipperhq.com/installing-the-magento-2-shippingapps-pocztexrate-extension/).

Support
-------
For further information on using Pocztexrates, please refer to our [online documentation](http://docs.shipperhq.com/category/troubleshooting/ecommerce-platform/pocztexrates/).
If you have any issues with this extension, open an issue on [GitHub](https://github.com/shippingapps/module-pocztexrate/issues). Alternatively you can contact us via email at support@shippingapps.com
 

ShippingApps PocztexRates is provided AS IS and we are not accepting feature requests at this time. Extended functionality is available via [ShipperHQ](https://www.shipperhq.com).

Magento Issues Impacting PocztexRates
-------
