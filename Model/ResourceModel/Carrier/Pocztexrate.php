...
namespace ShippingApps\PocztexRate\Model\ResourceModel\Carrier;
 ...
 */
class Pocztexrate extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
     ...
     * @param \ShippingApps\PocztexRate\Model\Carrier\Pocztexrate $carrierPocztexrate
    ...
    public function __construct(
        ...
        \ShippingApps\PocztexRate\Model\Carrier\Pocztexrate $carrierPocztexrate,
        ...
        $this->carrierPocztexrate = $carrierPocztexrate;
    ...
    {
        $this->_init('shippingapps_pocztexrate', 'pk');
    }
     ...
     *
     * @return \ShippingApps\PocztexRate\Model\ResourceModel\Carrier\Pocztexrate
     * @throws \Magento\Framework\Exception\LocalizedException
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
        ...
        if ($object->getData('groups/pocztexrate/fields/condition_name/inherit') == '1') {
            $conditionName = (string)$this->coreConfig->getValue('carriers/pocztexrate/condition_name', 'default');
        } else {
            $conditionName = $object->getData('groups/pocztexrate/fields/condition_name/value');
        }
    ...
    protected function getConditionFullName($conditionName)
    {
        if (!isset($this->conditionFullNames[$conditionName])) {
            $name = $this->carrierPocztexrate->getCode('condition_name_short', $conditionName);
